...
oper
  ...
  take_V2 = mkV2 (reflV (mkV "quitar" "quito")) ; --reflexive verb fixed
  put_V2 = mkV2 (reflV (mkV "poner" "pongo")) ; -- reflexive verb fixed, but declension is not right
  be_VA = mkVA (mkV "estar" "estoy") ;
